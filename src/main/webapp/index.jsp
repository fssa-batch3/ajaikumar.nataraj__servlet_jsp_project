...
<body>
		...
		<div class="head">
			...
			<div class="dropdown">
				...
				<div class="dropdown-content">
					<a onclick="buy_sign()">as Buyer</a> <a onclick="sell_sign()">as
						Seller</a>
				</div>
			</div>
			<div class="dropdown">
	...
	<section class="content_sec">
		...
		<p class="content_sec_p">
			If you are busy <br /> Buy products in RISHI
		</p>
	...
	<main class="card_main">
		...
		<div class="card_div">
			<img src="./assets/image/card_vegetables.jpg" alt="vegetable"
				width="275px" /> <b>Vegetables</b>
			<button onclick="buy_login()">Buy Now</button>
			<button onclick="buy_login()">Sell Now</button>
		</div>
		<div class="card_div">
			<img src="./assets/image/card_tea.jpg" alt="tea" width="275px" /> <b>Tea
				and Coffee</b>
			<button onclick="buy_login()">Buy Now</button>
			<button onclick="buy_login()">Sell Now</button>
		</div>
	...
	<section class="img_slide">
		<h1>Our Products</h1>
		<div>
			<img src="./assets/image/home-fruit.jpg" alt="fruit_img" /> <img
				src="./assets/image/home-vegetable.jpg" alt="vegetable_img" /> <img
				src="./assets/image/home-tea.jpg" alt="tea_img" /> <img
				src="./assets/image/home-grain.jpg" alt="grain_img" />
		</div>
	</section>

	<main class="buy_sell_main">
		<div class="buy_sell_div">
			<img src="./assets/image/buy_online.png" alt="buy_online"
				width="350px" />
			<p>You can buy Eatables in your home or office, whenever and
				wherever you want</p>
		</div>
		<div class="buy_sell_div">
	...
	<section class="img_slide">
		...
		<div>
			<img src="./assets/image/honey.jpg" alt="honey_img" /> <img
				src="./assets/image/juice.jpg" alt="juice_img" /> <img
				src="./assets/image/milk_products.jpg" alt="milk_img" /> <img
				src="./assets/image/nuts.jpg" alt="nuts_img" />
		</div>
	</section>
	...
	<footer id="foot">
		...
		<div class="foot-1">
			...
			<ul>
				<i class="fa fa-phone"
					style="font-size: 24px; color: rgb(49, 49, 176)"></i> 9876543210
			</ul>
			<ul>
				<i class="fa fa-envelope"
					style="font-size: 24px; color: rgb(245, 11, 11)"></i>
			...
			<ul>
				...
				Rishi office, Global Infocity,
				<br /> Perungudi, Chennai 600096
			</ul>
		</div>
		<div class="foot-2">
			<h4>Follow us on</h4>
			<div class="follow">
				<ul>
					<i class="fa fa-youtube-play"
						style="font-size: 24px; color: rgb(254, 4, 4)"></i> You Tube
				</ul>
				<ul class="fb">
				...
				<ul>
					<i class="fa fa-twitter" style="font-size: 24px; color: skyblue"></i>
					Twitter
				</ul>
				<ul>
	...
	<nav class="copyright">@ copyright 2022 RISHI AGRI MARKET | All
		rights reserved</nav>
