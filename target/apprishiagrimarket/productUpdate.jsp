...
<body>
	...
	<form action="RegisterProductUpdate?id=<%=product.getId()%>"
			...
			<div class="list">
				<nav>
					<label for="url">Product's Url</label> <input type="url" name="url"
						value=<%=product.getUrl()%> id="url" />
				</nav>
				<nav>
					<label for="name">Product's Name</label> <input required="required"
						value=<%=product.getName()%> type="text" name="name" id="name" />

				</nav>
				<nav>
					<label for="type">Product's Type</label> <input required="required"
						list="Types" name="type" id="type" autocomplete="off"
			...
			<div class="list">
				...
				<nav>
					<label for="city">City Name</label> <input required="required"
						type="text" id="city" name="city" value=<%=product.getCity()%> />
				</nav>
				<nav>
		...
		<div class="btn-card">
			<button class="btn" id="add-btn" type="submit">Edit</button>
		</div>
	</form>
</body>
</html>