...
<body class="body">
	...
	<div class="form">
		<form action="LoginServlet" method="post" class="center" id="form">
			<nav>
				<img src="./assets/image/login.png" alt="profile" width="350px" />
			</nav>
			<label>User Mail id:</label><br /> <input type="text" id="Email" value="kannan@gmail.com"
				required name="email" /><br /> <label>Password:</label><br />
			<input name="password"  type="password" id="Password" required value="Ajai@12345" />
			<br />
